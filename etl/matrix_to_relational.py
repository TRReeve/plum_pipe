...
if __name__ == '__main__':
    ...
    parser.add_argument('--x_axis_name', default='x_axis', help='x axis name of matrix')
    parser.add_argument('--y_axis_name', default='y_axis', help='y axis name of matrix')
    parser.add_argument('--fact_name', default='fact', help='name of kpi you\'re measuring')
